...
def _add_correlation_id(_logger: Any, _name: str,
...
def _add_subsystem(_logger: Any, _name: str,
                   event_dict: dict[str, Any]) -> dict[str, Any]:
...
def configure_logging(level: str | None = None, fmt: str | None = None) -> None:
    ...
    Args:
        level: log level name (DEBUG / INFO / WARNING / ERROR / CRITICAL).
            Defaults to MEDIASTACK_LOG_LEVEL env var, then INFO.
        fmt:  output format ("json" or "console"). Defaults to
            MEDIASTACK_LOG_FORMAT env var, then "console".
    """
    global _configured
    level_str = (level or os.environ.get("MEDIASTACK_LOG_LEVEL", "INFO")).upper()
    fmt_str = (fmt or os.environ.get("MEDIASTACK_LOG_FORMAT", "console")).lower()
