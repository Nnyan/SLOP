...
def _maybe_auto_apply_safe_fixes() -> None:
    ...
    from backend.agent.circuit_breaker import (
        check_circuit as _check_circuit,
        check_app_circuit as _check_app_circuit,
    )
    ...
    # per-app cap (5 fixes/app/hour). One flapping app cannot exhaust the
    # global budget for the whole fleet. The global cap above remains intact.
