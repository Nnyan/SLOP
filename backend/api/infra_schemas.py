...
PROVIDER_CONFIG_SCHEMAS: dict[str, list[dict[str, Any]]] = {
    ...
    "headscale": [
        ...
        },
        {
            ...
            "required": False,
            "secret": False,
            "help": "How this node appears in your Headscale network. Defaults to \'mediastack\'.",
        },
    ],
    "tailscale": [
        {
        ...
        },
        {
            ...
            "required": False,
            "secret": False,
            "help": "How this server appears on your tailnet. Defaults to 'mediastack'.",
        },
        {
            "key": "routes",
    ...
    "dockhand": [
        ...
        },
        {
            ...
            "required": False,
            "secret": False,
            "help": "Use the Mediastack managed PostgreSQL instead of SQLite. Recommended for multi-user setups.",
        },
    ],
    "dockge": [
        {
