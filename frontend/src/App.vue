  ...
  <div class="min-h-screen bg-slate-50 flex">
    ...
    <aside class="w-60 shrink-0 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0">
      ...
      <div class="px-4 py-3 border-b border-slate-100">
        <div v-if="platformStore.isReady" class="flex items-center gap-2.5">
        ...
        <div v-else class="flex items-center gap-2 text-xs">
          ...
          <RouterLink to="/setup" class="text-amber-600 font-medium hover:text-amber-700">
            Setup required →
          </RouterLink>
        </div>
      </div>
      ...
      <div class="px-4 py-3 border-t border-slate-100">
        <div class="flex items-center justify-between text-xs text-slate-400">
          ...
          <RouterLink to="/health" class="hover:text-sky-500 font-medium">Health</RouterLink>
        </div>
      </div>
    </aside>

    <!-- Main -->
    <main class="flex-1 min-w-0 overflow-y-auto" style="scrollbar-gutter: stable">
      <!-- Notification banner -->
      <Transition name="slide-down">
        <div v-if="notification"
          ...
          <button @click="notification = null" class="opacity-60 hover:opacity-100 ml-4">✕</button>
        </div>
      </Transition>
