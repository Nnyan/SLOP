#!/bin/bash
# docker-entrypoint.sh — Mediastack container startup
set -euo pipefail

DATA_DIR="${MS_DATA_DIR:-/srv/mediastack/data}"
CONFIG_DIR="${MS_CONFIG_ROOT:-/srv/mediastack/config}"

echo "→ Mediastack starting up…"
