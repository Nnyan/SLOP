...
fetch_repo() clones the mediastack repo to install_dir at a pinned tag and
...
def fetch_repo(
    ...
    *,
    ...
    """Clone the mediastack repo to install_dir at the given version_ref.
    ...
    mediastack_version matches the resolved tag, the clone is skipped and
    ...
    if state is not None and state.mediastack_version == resolved:
        return resolved
