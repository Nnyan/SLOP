...
ensure_user() creates the unprivileged `mediastack` system user per
...
def ensure_user(
    *,
    ...
    """Create the mediastack system user and add it to the docker group.
