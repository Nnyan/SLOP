...
-- Mediastack v3 — SQLite State Schema
-- This database is the single source of truth for everything Mediastack
...
-- ---------------------------------------------------------------------------
-- Apps
-- Every Layer 2 app installed through Mediastack.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- External resources
-- Everything Mediastack has provisioned outside Docker:
...
-- ---------------------------------------------------------------------------
-- Operations log
-- Append-only record of every significant action Mediastack takes.
...
INSERT OR IGNORE INTO settings (key, value) VALUES
    ('registry_url', 'https://raw.githubusercontent.com/Nnyan/mediastack/main/catalog/registry.json'),
