...
**Authoritative source.** CORE_RULES.md (moved to the slop-process private repo; enforced locally via ms-enforce — run `python3 ms-enforce --list`).
...
**Scope.** `ms-coverage` source; coverage_map.json (generated by `ms-enforce --list`).
