...
- docs/REVIEW-LOG.md — independent-review entries for significant changes (each records the reviewer, charge, findings + the author's per-finding reconciliation)
