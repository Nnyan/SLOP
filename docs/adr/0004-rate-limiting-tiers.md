...
**See also:** STEP_2_4_RATE_LIMITING_STRATEGY.md (cleanup strategy doc moved to slop-process private repo), Core Rule 4.14 (Rate Limiting Discipline) — enforced by ms-enforce
