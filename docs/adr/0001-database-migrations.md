...
**Supersedes:** none
**See also:** STEP_1_1_DB_MIGRATIONS_STRATEGY.md (cleanup strategy doc moved to slop-process private repo), Core Rule 6.1 (Migration Discipline) — enforced by ms-enforce
